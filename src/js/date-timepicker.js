    ...
    Plugin.prototype = {
        ...
        initTemplate: function() {
            ...
            this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                ...
                '<div class="ripplelink button dtp-btn-cancel" style="margin-left:10px;width:100px;color:#747474;">' + this.params.cancelText + '</div>' +
                '<div class="ripplelink button dtp-btn-ok" style="width:75px;color:var(--theme_1)">' + this.params.okText + '</div>' +
                '<div class="clearfix"></div>' +
                '</div>' +
                '</div>' +
                '</div>';
        ...
        initHours: function() {
            ...
            for (var i = 0; i < 12; i++) {
                ...
                var fill = ((this.currentDate.format(hFormat) == i) ? "var(--theme_1)" : 'transparent');
            ...
            if (!this.params.shortTime) {
                for (var i = 0; i < 12; i++) {
                    ...
                    var fill = ((this.currentDate.format(hFormat) == (i + 12)) ? "var(--theme_1)" : 'transparent');
        ...
        initMinutes: function() {
            ...
            for (var i = 0; i < 60; i++) {
                ...
                var color = ((this.currentDate.format("m") == i) ? "var(--theme_1)" : 'transparent');
        ...
        createSVGClock: function(isHour) {
            ...
            if (isHour) {
                ...
                var svgHourHand = this.createSVGElement("line", { class: 'hour-hand', x1: 0, y1: 0, x2: 0, y2: hl, stroke: 'var(--theme_1)', 'stroke-width': 8 });

                svgGElement.appendChild(svgMinuteHand);
                svgGElement.appendChild(svgHourHand);
            } else {
                var svgMinuteHand = this.createSVGElement("line", { class: 'minute-hand', x1: 0, y1: 0, x2: 0, y2: -150, stroke: 'var(--theme_1)', 'stroke-width': 2 });
        ...
        _onSelectHour: function(e) {
            if (!$(e.target).hasClass('disabled')) {
                ...
                $(parent.find('#h-' + value)).attr('fill', 'var(--theme_1)');
        ...
        _onSelectMinute: function(e) {
            if (!$(e.target).hasClass('disabled')) {
                ...
                $(parent.find('#m-' + value)).attr('fill', 'var(--theme_1)');
