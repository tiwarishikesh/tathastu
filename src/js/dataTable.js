...
(function($, window, document, undefined) {
    ...
    function _fnFeatureHtmlFilter(settings) {
        ...
        var input = `<div class="group">
        <input type="text" class="${classes.sFilterInput}" required />
        <span class="highlight"></span>
        <span class="bar"></span>
        <label class="custom">${settings.oInit.search_label == undefined ? "Search" : settings.oInit.search_label}</label>
        </div>`
