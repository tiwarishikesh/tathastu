...
$routes = array(
    ...
    ["POST","upload-doc-one", "build/building.php","uploaddocone","",[]],
    ["POST","upload-doc-two", "build/building.php","uploaddoctwo","",[]],

    ["GET","document", "build/building.php","readDocument","auth",[]],
    ["POST","document-one", "build/building.php","createDocumentOne","auth",[]],
    ["POST","document-two", "build/building.php","createDocumentTwo","auth",[]],
    ["PUT","member", "build/building.php","updateMember","auth",[]],
